...
func addTransaksi(N *tabNasabah, R *rekening, jumlah float64, tanggal, tipe string, hitungN int) { //melakukan proses transfer
...
func transaksiSaldo(N *tabNasabah, R *tabRekening, hitungR, hitungN int) { //melakukan transfer antar akun
